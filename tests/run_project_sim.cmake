if(NOT DEFINED SCMD OR NOT DEFINED SCMDSIM OR NOT DEFINED PROJECT OR NOT DEFINED WORKDIR OR NOT DEFINED EXEC_NAME OR NOT DEFINED EXPECT)
    message(FATAL_ERROR "run_project_sim.cmake missing required -D argument")
endif()
...
execute_process(
    COMMAND "${SCMDSIM}" "${cfgroot}" --exec "${EXEC_NAME}" --no-interactive --no-engine-messages --no-ansi --max-commands "${MAX_COMMANDS}"
